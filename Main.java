public class Main {
  public static void main(String[] args) {
    ...
    String bestCase = "A";
//match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");
    ...
    System.out.print("Elapsed time for best case:");
...
//match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");match("Elmo","mo");    
    ...
    System.out.print("Elapsed time for worst case:");
    System.out.println(elapsedTime);
